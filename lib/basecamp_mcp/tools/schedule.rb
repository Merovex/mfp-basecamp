...
module BasecampMcp
  module Tools
    ...
    class ListScheduleEntries < MCP::Tool
      ...
      class << self
        def call(project_id:, schedule_id:, status: nil, server_context:)
          params = {}
    ...
    class CreateScheduleEntry < MCP::Tool
      ...
      input_schema(
        properties: {
          ...
          participant_ids: { type: "array", items: { type: "integer" }, description: "People IDs to add as participants" },
      ...
      class << self
        def call(project_id:, schedule_id:, summary:, starts_at:, ends_at:,
                 description: nil, all_day: nil, participant_ids: nil, notify: nil, server_context:)
    ...
    class UpdateScheduleEntry < MCP::Tool
      ...
      class << self
        def call(project_id:, entry_id:, summary: nil, starts_at: nil, ends_at: nil,
                 description: nil, all_day: nil, participant_ids: nil, notify: nil, server_context:)
          body = {}
